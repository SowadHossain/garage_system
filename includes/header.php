...
<head>
    ...
    <!-- App CSS -->
    <link rel="stylesheet" href="/garage_system/public/assets/css/style.css">
</head>
<body>
    ...
    <div class="container-fluid">
        ...
        <?php if (!empty($_SESSION['staff_id'])): ?>
            <div class="d-flex align-items-center gap-3">
                ...
                <?php
                // Role badge (if role_check.php loaded)
        ...
        <?php elseif (!empty($_SESSION['customer_id'])): ?>
            <div class="d-flex align-items-center gap-3">
                ...
                <a class="btn btn-outline-light btn-sm"
                   href="/garage_system/public/customer_portal/customer_logout.php">
                    <i class="bi bi-box-arrow-right me-1"></i>Logout
                </a>
            </div>
        <?php endif; ?>
